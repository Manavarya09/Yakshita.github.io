...
const Contact = () => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Mushroom25', label: 'GitHub', color: 'text-pastel-lavender' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/yakshita-verma-a16b4a331/', label: 'LinkedIn', color: 'text-pastel-mint' },
    { icon: Instagram, href: 'https://www.instagram.com/yakshita_verma/', label: 'Instagram', color: 'text-pastel-pink' },
    { 
      icon: () => (
